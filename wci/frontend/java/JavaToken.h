 ...
 */
            ...
            constexpr JavaTokenType PT_ONELINE_COMMENT = JavaTokenType::ONELINE_COMMENT;
            constexpr JavaTokenType PT_BEGIN_COMMENT = JavaTokenType::BEGIN_COMMENT;
            constexpr JavaTokenType PT_END_COMMENT = JavaTokenType::END_COMMENT;
