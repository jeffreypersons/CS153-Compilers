...
private:
     ...
     * @return nullptr.
     */
    CellValue *execute_read_readln(ICodeNode *call_node,
     ...
     * @throw a string message if an error occurred.
     */
    CellValue *parse_boolean(Token *token) throw (string);
     ...
     * @return nullptr.
     */
    CellValue *execute_write_writeln(ICodeNode *call_node,
                                     RoutineCode routine_code);
     ...
     */
    CellValue *execute_eof_eoln(ICodeNode *call_node,
                                RoutineCode routine_code);
     ...
     */
    CellValue *execute_abs_sqr(ICodeNode *call_node,
                               RoutineCode routine_code,
     ...
     * @return the function value.
     */
    CellValue *execute_arctan_cos_exp_ln_sin_sqrt(ICodeNode *call_node,
                                                  RoutineCode routine_code,
                                                  ICodeNode *actual_node);
     ...
     * @return the function value.
     */
    CellValue *execute_pred_succ(ICodeNode *call_node,
                                 RoutineCode routine_code,
                                 ICodeNode *actual_node,
                                 TypeSpec *typespec);
     ...
     * @return the function value.
     */
    CellValue *execute_chr(ICodeNode *call_node, RoutineCode routine_code,
                           ICodeNode *actual_node);
     ...
     * @return true or false.
     */
    CellValue *execute_odd(ICodeNode *call_node, RoutineCode routine_code,
                           ICodeNode *actual_node);
     ...
     * @return the function value.
     */
    CellValue *execute_ord(ICodeNode *call_node, RoutineCode routine_code,
                           ICodeNode *actual_node);
     ...
     * @return the function value.
     */
    CellValue *execute_round_trunc(ICodeNode *call_node,
                                   RoutineCode routine_code,
                                   ICodeNode *actual_node);
};
